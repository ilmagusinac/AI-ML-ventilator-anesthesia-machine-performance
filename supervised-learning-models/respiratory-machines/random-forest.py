...
# Set 'N/A' in Usklađeno column if columns 'Mjerena vrijednost' || 'Greška mjerenja [%]' are 'NIJE MJERENO' (in our case null)
for i in range(1, 24):
...
#data.to_csv("files/respiratory_cleaned_with_features.csv", index=False, encoding="utf-8")
