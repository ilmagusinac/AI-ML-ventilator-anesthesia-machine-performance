...
calibrated_rf = CalibratedClassifierCV(grid_search.best_estimator_, cv=3)  # use cv=3 if you don’t have many NE
...
print(riskiest_test_machines.head(275))
...
print(devices_counts_sorted.head(275))
